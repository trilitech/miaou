...
(* Tiny 3×5 pixel digit font for score popups; digits/symbols come from
   the shared arcade font, extended here with letters for in-game text
   ("BOSS", "LEVEL N CLEAR!", etc). *)
